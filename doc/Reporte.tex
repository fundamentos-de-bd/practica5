...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item {
            ...
            \begin{align*}
                r &\leftarrow (_{id\_clientes}G_{min(fecha\_reg)}(Cliente)) \\
        ...
        \item {
            ...
            \begin{align*}
                r &\leftarrow (_{id\_suc}G_{count(id\_suc)}(Departamento \bowtie Producto)) \\
                r &\leftarrow \rho_{num\_prod(count(id\_suc))}(r) \\
                r &\leftarrow \pi_{id\_suc}(_{id\_suc}G_{max(num\_prod)}(r)) \\
                r &\leftarrow r \bowtie Sucursal
            \end{align*}
        }
        \item {
